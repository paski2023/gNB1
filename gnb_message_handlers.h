...
void set_ue_properties(int rnti, bool prop_1, float prop_2, float ue_ber_uplink, float ue_ber_downlink, float ue_mcs_uplink, float ue_msc_downlink, float ue_rsrp, int cell_size);
